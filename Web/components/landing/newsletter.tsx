        ...
        <div className="relative rounded-[1.7rem] bg-surface-paper px-8 py-14 md:px-14 md:py-16">
          <div className="mx-auto max-w-xl text-center">
            ...
            <p className="mt-3 font-body text-on-surface-variant">
              Product updates and seasonal ideas—no spam. Wire this to your email tool when ready.
            </p>
            {status === 'done' ? (
              ...
              <form onSubmit={onSubmit} className="mt-10 flex flex-col gap-3 sm:flex-row sm:justify-center">
                ...
                <input
                  ...
                  autoComplete="email"
                  className="min-h-[52px] flex-1 rounded-pill border border-outline-variant/20 bg-surface-high px-6 font-body text-on-surface placeholder:text-on-surface-variant/55 focus:border-primary/25 focus:bg-surface-paper focus:outline-none focus:ring-2 focus:ring-primary/20 sm:max-w-sm"
                />
                <button
                  type="submit"
                  data-analytics="newsletter_submit"
                  className="btn-shine min-h-[52px] rounded-pill bg-gradient-to-r from-primary to-primary-container px-10 font-body font-semibold text-on-primary shadow-glow transition hover:scale-[1.02] active:scale-[0.98]">
                  Notify me
                </button>
              </form>
            )}
